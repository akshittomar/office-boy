    ...
    <>
      ...
      <div id="carouselExampleAutoplaying" style={{ marginRight: "3%", marginLeft: "25%" }} className="carousel slide" data-bs-ride="carousel">
        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img src={image} className="d-block " loading='lazy' style={{ width: "30%" }} alt="..." />
            <div className="">
          ...
          <div className="carousel-item">
            <img src={image2} className="d-block " loading='lazy' style={{ width: "30%" }} alt="..." />
            <div className="">
          ...
          <div className="carousel-item">
            <img src={image3} className="d-block " loading='lazy' style={{ width: "30%" }} alt="..." />
            <div className="" >
      ...
      <div className="col-md-3 my-2 mx-5 card" style={headingStyle}    >
        <div className="card my-4 shadow-lg  bg-body-tertiary rounded " style={{ width: "50vp" }}>
          ...
          <img className="card-img-top" src={img} loading='lazy' style={{ backgroundSize: "50%" }} alt="Card image cap"></img>
      ...
      <div className="col-md-3 my-2 mx-5 card" style={headingStyle}    >
        <div className="card my-4 shadow-lg  bg-body-tertiary rounded " style={{ width: "50vp" }}>
          ...
          <img className="card-img-top" src={img} style={{ backgroundSize: "50%" }} loading='lazy' alt="Card image cap"></img>
          <div className="card-body  ">
