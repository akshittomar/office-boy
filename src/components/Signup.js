...
const headingStyle = {
  ...
  return (
    ...
    <div className="mb-3">
    <label htmlFor="uname" className="form-label" style={{width:"25%"}}>ENTER YOUR NAME </label>
  ...
  <label className="input-group-text"  htmlFor="inputGroupSelect01" style={{width:"30%"}}>PROFILE:</label>
  ...
  <div className="mb-3">
    <label htmlFor="password" className="form-label" style={{width:"25%"}}>Password</label>
